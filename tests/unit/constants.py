...
FULL_CONFIG_FILE = {'capabilities': CHANGE_SET_CAPABILITIES, 'profile': PROFILE, 'region': REGION, 'stack': STACK, 'parameters': CHANGE_SET_PARAMETERS, 'tags': CHANGE_SET_STACK_TAGS, 'role-arn': ROLE_ARN, 'vars': VARS}  # noqa
